...
func TestNewsById(t *testing.T) {
	...
	newsArticleJson, err := TibiaNewsImpl(6529, "https://www.tibia.com/news/?subtopic=newsarchive&id=6529", string(data))
	if err != nil {
		t.Fatal(err)
	}
...
func TestNews6512(t *testing.T) {
	...
	newsArticleJson, err := TibiaNewsImpl(6512, "https://www.tibia.com/news/?subtopic=newsarchive&id=6512", string(data))
	if err != nil {
		t.Fatal(err)
	}
	...
	assert.Equal("<a href=\"https://tibiadata.com\" rel=\"noopener noreferrer\" target=\"_blank\">TibiaData.com</a> has some news to share! First of all, they invite you to participate in their <a href=\"https://tibiadata.com/2021/07/join-tibiadata-on-discord/\" rel=\"noopener noreferrer\" target=\"_blank\">Discord Server</a>. Further, they are now present on <a href=\"https://tibiadata.com/2021/12/tibiadata-has-gone-open-source/\" rel=\"noopener noreferrer\" target=\"_blank\">GitHub</a>. They are working on their <a href=\"https://tibiadata.com/doc-api-v3/v3-beta/\" rel=\"noopener noreferrer\" target=\"_blank\">v3</a>, which is still in beta. If you are interested in such things, head on over there to see what is cooking.", newsArticleJson.News.ContentHTML)
}
...
func TestNews6481(t *testing.T) {
	...
	newsArticleJson, err := TibiaNewsImpl(6481, "https://www.tibia.com/news/?subtopic=newsarchive&id=6481", string(data))
	if err != nil {
		t.Fatal(err)
	}
